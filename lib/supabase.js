...
// ตาราง Supabase สำหรับการตั้งค่าร้าน (Contact & Social Links ฯลฯ) — เก็บเป็นแถวเดียว (singleton)
// ต้องสร้างตารางนี้ไว้ล่วงหน้าแบบ manual ผ่าน Supabase SQL Editor ก่อน (ดู supabase/settings-schema.sql)
